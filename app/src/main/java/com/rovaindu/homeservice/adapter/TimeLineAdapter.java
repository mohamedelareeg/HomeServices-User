...
import com.rovaindu.homeservice.utils.DateTimeUtils;
...
import com.rovaindu.homeservice.utils.timeline.VectorDrawableUtils;
...
public class TimeLineAdapter extends RecyclerView.Adapter<TimeLineViewHolder> {
    ...
    public void onBindViewHolder(TimeLineViewHolder holder, int position) {
        ...
        if(timeLineModel.getStatus() == OrderStatus.INACTIVE) {
            ...
            holder.mTimelineView.setMarker(VectorDrawableUtils.getDrawable(mContext, R.drawable.ic_marker_active, R.color.primaryColorYellowBlack));
        } else {
            holder.mTimelineView.setMarker(ContextCompat.getDrawable(mContext, R.drawable.ic_marker), ContextCompat.getColor(mContext, R.color.primaryColorYellowBlack));
        }
