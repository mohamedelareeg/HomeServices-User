...
public class TextViewAr extends TextView {
    ...
    public TextViewAr(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initAttrs(context, attrs);
        init();
    }

    public TextViewAr(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
