...
public class ThemeUtil {
    public static final int THEME_YELLOWBLACK = 0;
    ...
    public static int getThemeId(int theme){
        ...
        switch (theme){
            ...
            case THEME_BLUEGRAY  :
                ...
                break;
            case THEME_YELLOWBLACK  :
                themeId = R.style.AppTheme_YELLOWBLACK;
                break;
            default:
                break;
        }
    ...
    public static ArrayList<Theme> getThemeList(){
        ...
        themeArrayList.add(new Theme(0,R.color.primaryColorYellowBlack, R.color.primaryDarkColorYellowBlack, R.color.secondaryColorYellowBlack));
        ...
        themeArrayList.add(new Theme(19,R.color.primaryColorRed, R.color.primaryDarkColorRed, R.color.secondaryColorRed));
