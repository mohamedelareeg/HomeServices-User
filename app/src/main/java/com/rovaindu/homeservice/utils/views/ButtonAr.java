...
public class ButtonAr extends Button {


    public ButtonAr(Context context) {
        super(context);
        init();
    }

    public ButtonAr(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initAttrs(context, attrs);
        init();
    }

    public ButtonAr(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
