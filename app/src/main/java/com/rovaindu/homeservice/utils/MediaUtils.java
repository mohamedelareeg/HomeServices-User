...
import static com.rovaindu.homeservice.utils.views.chat.Utils.generateFileName;
import static com.rovaindu.homeservice.utils.views.chat.Utils.getDocumentCacheDir;
import static com.rovaindu.homeservice.utils.views.chat.Utils.getFileName;
        ...
        if (isKitKat && DocumentsContract.isDocumentUri(context, uri)) {
            ...
            if (isExternalStorageDocument(uri)) {
                ...
                if ("primary".equalsIgnoreCase(type)) {
                    return context.getExternalFilesDir(null).getAbsolutePath() + "/Media"
                            + File.separator + "Images" + "/" + split[1];
                }
