package com.rovaindu.homeservice.controller.map;
...
import com.rovaindu.homeservice.controller.agents.AgentsActivity;
...
import com.rovaindu.homeservice.utils.map.CurrentPlaceSelectionBottomSheet;
import com.rovaindu.homeservice.utils.map.PermissionUtility;
...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appname.setText(getResources().getString(R.string.confirm_location));
        ...
        mBtnSelectAddress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (addresses != null) {
                    ...
                    UserAddress userAddress = new UserAddress(latitude,longitude,shortAddress);
                    ServiesSharedPrefManager.getInstance(getApplicationContext()).userLocation(userAddress.getLatitude() + "," + userAddress.getLongitude());
                    ServiesSharedPrefManager.getInstance(getApplicationContext()).setOLocation(userAddress);

                    Intent i = new Intent(MapActivity.this, AgentsActivity.class);
                    i.putExtra(Constants.BUNDLE_CATEGORIES_LIST, (Serializable) category);
                    i.putExtra(Constants.ADDRESS_INTENT, addressData);
...
//        mBtnCurrentLocation.setVisibility(View.GONE);
        mBtnCurrentLocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (PermissionUtility.checkLocationFineAndCoarsePermission(MapActivity.this))
                    startLocationUpdates();
            }
        });
